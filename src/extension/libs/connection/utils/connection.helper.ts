...
export abstract class ConnectionHelper {
     ...
     */
    public static buildUrl(connection: Connection): string {
     ...
     */
    public static buildWebsocketUrl(connection: Connection, id = "engineData"): string {
     ...
     */
    public static createWebsocket(url: string, connection: Connection): WebSocket
    {
        const headers = {
            Cookie: ""
        };
     ...
     */
    public static createSession(connection: Connection, id?): enigmaJS.ISession
    {
